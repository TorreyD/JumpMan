...
import com.fullsail.etmg.torreydaniel.jumpman.LevelCompleteWindow.StarsCount;
...
public class GameScene extends BaseScene implements IOnSceneTouchListener {
	...
	private static final Object TAG_ENTITY_ATTRIBUTE_TYPE_VALUE_GEM = "gem";
	...
	private void createBackground() {
		setBackground(new Background(getColor().BLUE));
	}
	...
	private void createHUD() {
		...
		// SCORE TEXT
		scoreText = new Text(130f, 450f, resourceManager.font,
					...
					public IEntity onLoadEntity(
						...
						if (type.equals(TAG_ENTITY_ATTRIBUTE_TYPE_VALUE_PLATFORM1)) {
							levelObject = new Sprite(x, y,
									resourceManager.platform1_region, vbom);
							...
							levelObject = new Sprite(x, y,
									resourceManager.platform2_region, vbom);
							...
							levelObject = new Sprite(x, y,
									resourceManager.platform3_region, vbom);
							final Body body = PhysicsFactory.createBoxBody(
									physicsWorld, levelObject,
									BodyType.StaticBody, FIXTURE_DEF);
							...
							physicsWorld
								...
								.equals(TAG_ENTITY_ATTRIBUTE_TYPE_VALUE_GEM)) {
							levelObject = new Sprite(x, y,
									resourceManager.gem_region, vbom) {
								@Override
							...
							player = new Player(x, y, vbom, camera,
								...
								@Override
								public void onDie() {
									if (!gameOverDisplayed && !displayingScore) {
										displayGameOverText();
									}
								}
							};
							...
							levelObject = new Sprite(x, y,
									resourceManager.complete_stars_region, vbom) {
								@Override
								protected void onManagedUpdate(
										float pSecondsElapsed) {
									super.onManagedUpdate(pSecondsElapsed);
									...
									if (player.collidesWith(this)) {
										...
										{
											levelCompleteWindow.display(
													StarsCount.THREE, GameScene.this,
													camera);
										}
		...
		ContactListener contactListener = new ContactListener() {
			public void beginContact(Contact contact) {
				...
				if (x1.getBody().getUserData().equals("platform2")
						&& x2.getBody().getUserData().equals("player")) {
					engine.registerUpdateHandler(new TimerHandler(0.05f,
							new ITimerCallback() {
								public void onTimePassed(
										final TimerHandler pTimerHandler) {
									pTimerHandler.reset();
